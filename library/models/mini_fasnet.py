...
class MiniFASNetV1(MiniFASNet):
    def __init__(self, embedding_size=128, conv6_kernel=(7, 7),
                 drop_p=0.2, num_classes=3, img_channel=3):
        super(MiniFASNetV1, self).__init__(keep_dict['1.8M'],
                                           embedding_size=embedding_size, conv6_kernel=conv6_kernel,
                                           drop_p=drop_p, num_classes=num_classes, img_channel=img_channel)
...
class MiniFASNetV2(MiniFASNet):
    def __init__(self, embedding_size=128, conv6_kernel=(7, 7),
                 drop_p=0.2, num_classes=3, img_channel=3):
        super(MiniFASNetV2, self).__init__(keep_dict['1.8M_'],
                                           embedding_size=embedding_size, conv6_kernel=conv6_kernel,
                                           drop_p=drop_p, num_classes=num_classes, img_channel=img_channel)


class MiniFASNetV1SE(MiniFASNetV1):
    def __init__(self, embedding_size=128, conv6_kernel=(7, 7),
                 drop_p=0.75, num_classes=3, img_channel=3):
        super(MiniFASNetV1SE, self).__init__(embedding_size=embedding_size, conv6_kernel=conv6_kernel,
                                             drop_p=drop_p, num_classes=num_classes, img_channel=img_channel)


class MiniFASNetV2SE(MiniFASNetV1):
    def __init__(self, embedding_size=128, conv6_kernel=(7, 7),
                 drop_p=0.75, num_classes=3, img_channel=3):
        super(MiniFASNetV2SE, self).__init__(embedding_size=embedding_size, conv6_kernel=conv6_kernel,
                                             drop_p=drop_p, num_classes=num_classes, img_channel=img_channel)
